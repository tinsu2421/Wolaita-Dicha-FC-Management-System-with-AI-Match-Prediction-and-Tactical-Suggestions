...
?>
          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Player List <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $param = 1;
                        $dataUserList = $CommonOBJ->fetchPlayers();
                        $rowUserList = $CommonOBJ->fetchPlayers();
                        if ($rowUserList > 0) {
                          // code...
                          $x = 0;
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary"><?= $value['email']; ?></a></td>
                        <td><a href="#" class="text-primary"><?= $value['phone']; ?></a></td>
                        
                        <td>
                          <?php if ($value['status'] == 1) { ?>
                            <h3 class="bi bi-toggle-on bi-2"></h3>
                            <!-- <span class="bi bi-sun"></span> -->
                          <?php } else{ ?>
                            <h3 class="bi bi-toggle-off bi-2"></h3>
                            <!-- <span class="bi bi-sun"></span> -->
                         <?php } ?>
                        </td>
                      
                      <td>
                        <?php $status = (int)$value['status']; // cast to integer ?>

                        <?php if ($status == 1) : ?>
                            <!-- ACTIVE - View only (Coach cannot change status) -->
                            <span class="badge bg-success" style="font-size:10px;">
                                Active
                            </span>
                        <?php else: ?>
                            <!-- PENDING - View only (Coach cannot change status) -->
  ...
  <!-- Coach can only view player status, not change it -->
  <!-- Approve/Unapprove functionality removed - only Admin/Tech Director can approve players -->
