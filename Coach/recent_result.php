          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Match Results<span>| View Only</span></h5>
                  <p class="text-info text-center mb-3" style="font-size: 12px; font-style: italic;">
                    <i class="bi bi-info-circle me-1"></i>
                    Coaches have view-only access to match results. Contact Secretary for result modifications.
                  </p>
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        $dataQMatchResult = $CommonOBJ->fetchRecentResult();
                        $rowQMatch = $CommonOBJ->fetchRecentResult();
                        if ($rowQMatch > 0) {
                          // code...
                          $x = 0;
                      ...
                      <tr>
                        ...
                        <td><?= date('M d, Y', strtotime($value['match_date'])); ?></td>
                        <td><?= $value['home_club_id']; ?></td>
                        <td><?= $value['away_club_id']; ?></td>
