...
$db = new Database();
$stmt = $db->conn->prepare("SELECT * FROM fake_telebirr_transactions WHERE tx_ref = ?");
$stmt->execute([$tx_ref]);
...
<head>
    ...
    <title>Fake Telebirr Checkout - Testing Mode</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="fake-gateway text-center">
                    <div class="telebirr-logo">telebirr</div>
                    <h2><i class="bi bi-phone me-2"></i>FAKE TELEBIRR GATEWAY</h2>
                    <p class="mb-0">Testing Mode - No Real Money Involved</p>
                </div>
                
                <div class="payment-card">
                    <h4 class="text-center mb-4">Complete Your Mobile Payment</h4>
                    
                    <!-- Transaction Details -->
                    <div class="amount-display">
                        <h3 class="text-warning"><?= $fakePaymentHandler->formatAmount($transaction['amount']) ?></h3>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-6">
                            <strong>Prepay ID:</strong><br>
                            <span class="text-muted"><?= htmlspecialchars($transaction['prepay_id']) ?></span>
                        </div>
                    </div>
                    
                    <!-- Mobile Payment Simulation -->
                    <div class="alert alert-warning mb-4">
                        <h6><i class="bi bi-phone me-2"></i>Mobile Payment Simulation</h6>
                        <p class="mb-0">In real Telebirr, you would receive an SMS with USSD code to dial on your phone. This is a simulation for testing.</p>
                    </div>
                    ...
                    <div class="alert alert-info mt-4">
                        ...
                        <ul class="mb-0">
                            <li><strong>Successful Payment:</strong> Click green button to simulate successful mobile payment</li>
