                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $dataUserList = $CommonOBJ->fetchEachPlayers($params);
                        $rowUserList = $CommonOBJ->fetchEachPlayers($params);
                        if ($rowUserList > 0) {
                          // code...
                          $x = 0;
                    ...
                    <td>
                      ...
                      <a href="player_more.php?e=<?=base64_encode($value['player_id']); ?>" class="btn btn-primary" style="border-radius:3px;height:25px;font-size:10px;">More</a>
                    </td>
