          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Training Sckedule List<span>| Today</span></h5>
                  <p class="text-success text-center mb-3" style="font-size: 14px; font-weight: bold;"><?= $isPerformPlayerOBJ->SckeduleStatus(); ?></p>
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        $dataQMatchResult = $CommonOBJ->fetchTrainingSckedule();
                        $rowQMatch = $CommonOBJ->fetchTrainingSckedule();
                        if ($rowQMatch > 0) {
                          // code...
                          $x = 0;
