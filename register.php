                  ...
                  <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                      <select id="membership" name="membership" class="form-control">
                            ...
                            <!-- <option value="Free">Digital Only - Free</option> -->
                            <option value="digital">Digital Only - Free</option>
                            <option value="standard">Standard - $19.99/year</option>
                            <option value="premium">Premium - $49.99/year</option>
                            <option value="vip">VIP - $99.99/year</option>
                      </select>
...
//       $("#fan_label").on("blur keyup", function () {
//           let fan_label = $(this).val().trim();
//           if (fan_label === "Choose" || fan_label == null) {
...
//       $("#membership").on("blur keyup", function () {
//           let membership = $(this).val().trim();
//           if (membership === "Choose" || membership == null) {
...
//             $("#spanError-fullname").html("* Please enter a valid fullname.");
//          }else {
...
//     // Validate each field
//     const fields = [
//         { id: '#fullname', errorId: '#spanError-fullname', type: 'text', required: true },
//         { id: '#email', errorId: '#spanError-email', type: 'email', required: true },
//         { id: '#fan_label', errorId: '#spanError-fan_label', type: 'select', required: true },
//         { id: '#membership', errorId: '#spanError-membership', type: 'select', required: true },
//         { id: '#password', errorId: '#spanError-password', type: 'password', required: true, minLength: 6 }
//     ];
    
//     fields.forEach(field => {
//         const value = $(field.id).val().trim();
        
//         if (field.required && (value === "" || value === "Choose")) {
//             $(field.errorId).html("* This field is required.");
//             $(field.id).css("border-color", "red");
//             isValid = false;
//         } else if (field.type === 'email' && !isValidEmail(value)) {
//             $(field.errorId).html("* Please enter a valid email.");
//             $(field.id).css("border-color", "red");
//             isValid = false;
//         } else if (field.type === 'text' && !regexName.test(value)) {
//             $(field.errorId).html("* Please enter a valid name (letters only).");
//             $(field.id).css("border-color", "red");
//             isValid = false;
//         } else if (field.type === 'password' && value.length < field.minLength) {
//             $(field.errorId).html(`* Password must be at least ${field.minLength} characters.`);
//             $(field.id).css("border-color", "red");
//             isValid = false;
//         } else {
//             $(field.errorId).html("");
//             $(field.id).css("border-color", "green");
//         }
//     });
...
//   });
    ...
    function validateForm() {
        ...
        const fields = [
            ...
            { id: '#fan_label', errorId: '#spanError-fan_label', type: 'select', required: true },
            { id: '#membership', errorId: '#spanError-membership', type: 'select', required: true },
            { id: '#phone', errorId: '#spanError-phone', type: 'phone', required: true }
        ];
        ...
        fields.forEach(field => {
            ...
            if (field.required && (value === "" || value === "Choose")) {
                ...
                $(field.id).css("border-color", "red");
                isValid = false;
            } else if (field.type === 'phone' && !isValidEthiopianPhone(value)) {
                $(field.errorId).html("* Please enter a valid Ethiopian phone (9XXXXXXXX).");
                $(field.id).css("border-color", "red");
                isValid = false;
            } else {
                $(field.errorId).html("");
